...
@interface TextDataViewController ()<SaveObservationDelegate, UITextFieldDelegate>{
    CGRect viewRect;
...
@implementation TextDataViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if (prevData) {
        NSString *storedText = prevData.text;
